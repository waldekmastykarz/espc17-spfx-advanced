...
export default class Webpart2WebPartWebPart extends BaseClientSideWebPart<IWebpart2WebPartProps> {
        ...
        <div class="${styles.container}">
          <div class="ms-Grid-row ms-bgColor-themeDark ms-fontColor-white ${styles.row}">
            <div class="ms-Grid-col ms-lg10 ms-xl8 ms-xlPush2 ms-lgPush1">
              ...
              <p class="ms-font-l ms-fontColor-white">Bundle Webpart 2</p>
